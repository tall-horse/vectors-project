...
public class Coords
{
    ...
    static public void DrawPoint(Coords position, float width, Color color)
    {
        ...
        lineRenderer.material.color = color;
        lineRenderer.positionCount = 2;
        lineRenderer.SetPosition(0, new Vector3(position.x - width / 3.0f, position.y - width / 3.0f, position.z - width / 3.0f));
        lineRenderer.SetPosition(1, new Vector3(position.x + width / 3.0f, position.y + width / 3.0f, position.z + width / 3.0f));
        lineRenderer.startWidth = width;
        lineRenderer.endWidth = width;
    }
}
